...
def p_single_circ_gen(quantum_matrix, weights, flags, params):
...
# def p_single_circ_gen2(quantum_matrix, weights, flags, params):
...
#     inp_2 = QuantumRegister(4, "in2_qbit")
#     circ2 = QuantumCircuit(inp_2)
#     circ2.append(UnitaryGate(data_matrix, label="Input"), inp_2[0:4])

#     aux = QuantumRegister(2, "aux_qbit")
#     circ2.add_register(aux)

#     hidden_neurons = QuantumRegister(2, "hidden_qbits")
#     circ2.add_register(hidden_neurons)
...
#         if weight_1_2[idx] == -1:
#             state = "{0:b}".format(idx).zfill(4)
#             neg_weight_gate(circ2, inp_2, aux, state)
#             circ2.barrier()

#     circ2.h(inp_2)
#     circ2.x(inp_2)
#     ccccx(circ2, inp_2[0], inp_2[1], inp_2[2],
#         inp_2[3], hidden_neurons[1], aux[0], aux[1])
...
#     norm_q_2 = QuantumRegister(1, "norm_q_2_qbits")
#     out_q_2 = QuantumRegister(1, "out_q_2_qbits")
#     circ2.add_register(inter_q_2, norm_q_2, out_q_2)
...
#     for idx in range(weight_2_2.flatten().size()[0]):
#         if weight_2_2[idx] == -1:
#             circ2.x(hidden_neurons[idx])
#     circ2.h(inter_q_2)
#     circ2.cz(hidden_neurons[0], inter_q_2)
#     circ2.x(inter_q_2)
#     circ2.cz(hidden_neurons[1], inter_q_2)
#     circ2.x(inter_q_2)
#     circ2.h(inter_q_2)
#     circ2.x(inter_q_2)
...
#     norm_init_rad = float(norm_para_2.sqrt().arcsin()*2)
#     circ2.ry(norm_init_rad, norm_q_2)
#     if norm_flag_2:
#         circ2.cx(inter_q_2, out_q_2)
#         circ2.x(inter_q_2)
#         circ2.ccx(inter_q_2, norm_q_2, out_q_2)
#     else:
#         circ2.ccx(inter_q_2, norm_q_2, out_q_2)
...
#     circ2.barrier()
#     c_reg = ClassicalRegister(1, "reg")
#     circ2.add_register(c_reg)
#     circ2.measure(out_q_2, c_reg[0])
